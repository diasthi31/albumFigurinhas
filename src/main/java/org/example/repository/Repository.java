...
public class Repository {
    ...
    private void dbCreate() {
        try {
            ...
            stmt.executeUpdate("CREATE TABLE album(id INTEGER PRIMARY KEY AUTOINCREMENT, nome STRING NOT NULL, paginas INTEGER NOT NULL, capa BLOB NOT NULL, figurinhas String, FOREIGN KEY (figurinhas) REFERENCES figurinha(tag) ON DELETE CASCADE ON UPDATE CASCADE)");
            stmt.close();
